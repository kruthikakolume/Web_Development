...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            <br />
            <div class="container">
                <form:form modelAttribute="show" method="post">
                    <div class="mb-3">
                        <label for="title" class="form-label">Movie:</label><br />
                        <form:select path="movietitle">
                            <c:forEach var="mov" items="${requestScope.movieList}">
                                <form:option value="${mov}"/>
                            </c:forEach>
                        </form:select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <form:select path="postedBy">
                            <c:forEach var="postby" items="${requestScope.adminList}">
                                <form:option value="${postby}"/>
                            </c:forEach>
                        </form:select>
                    </div>
                    <br />
                    <div class="mb-3" style="margin-left: 70px;">
                        <button type="submit" class="btn btn-outline-dark">Post Show</button>
                    </div>
                </form:form>
            </div>
        </div>
